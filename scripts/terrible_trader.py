...
data.add_order_book_results(timestamp,'kraken',bid,ask,bid_volume,ask_volume)

buying, selling = thread2.get_thread_results()
data.add_order_book_results(timestamp, 'binance', bid, ask, bid_volume, ask_volume)

buying, selling = thread3.get_thread_results()
data.add_order_book_results(timestamp, 'bittrex', bid, ask, bid_volume, ask_volume)

buying, selling = thread4.get_thread_results()
data.add_order_book_results(timestamp, 'tradeogre', bid, ask, bid_volume, ask_volume)

buying, selling = thread5.get_thread_results()
data.add_order_book_results(timestamp, 'poloniex', bid, ask, bid_volume, ask_volume)
